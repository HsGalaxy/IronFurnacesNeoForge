...
public class ItemAugmentGenerator extends ItemAugmentBlue {
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext pContext, TooltipDisplay tooltipDisplay, Consumer<Component> components, TooltipFlag pTooltipFlag) {
        ...
        components.accept(Component.translatable("tooltip." + IronFurnaces.MOD_ID + ".augment_generator_pro").setStyle(Style.EMPTY.applyFormat((ChatFormatting.GREEN))));
        components.accept(Component.translatable("tooltip." + IronFurnaces.MOD_ID + ".augment_generator_con").setStyle(Style.EMPTY.applyFormat(ChatFormatting.DARK_RED)));
    }
